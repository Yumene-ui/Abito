						...
						<div className="content-box">
							<div className="content-product">
								<div className="content-product__left">
									...
									<img src="https://placehold.jp/460x357.png" alt="самокат" className="content-product__img" />
								...
								<div className="content-side__box">
									<div className="content-side__list">
										<div className="content-side__list-item">
											<img className="content-side__list-item--img" src="https://placehold.jp/30x30.png" alt="иконка" />
									...
									<div className="content-side__footer">
										<p className="content-side__footer--item">ООО Абита, 2011-2021</p>
